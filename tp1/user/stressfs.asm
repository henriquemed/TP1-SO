...
main(int argc, char *argv[])
{
  ...
  1a:	94a78793          	addi	a5,a5,-1718 # 960 <malloc+0x11c>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	90450513          	addi	a0,a0,-1788 # 930 <malloc+0xec>
  34:	75c000ef          	jal	ra,790 <printf>
  ...
  60:	8ec50513          	addi	a0,a0,-1812 # 948 <malloc+0x104>
  64:	72c000ef          	jal	ra,790 <printf>
...
//    printf(fd, "%d\n", i);
  ...
  9e:	8be50513          	addi	a0,a0,-1858 # 958 <malloc+0x114>
  a2:	6ee000ef          	jal	ra,790 <printf>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 444:	0805c163          	bltz	a1,4c6 <printint+0x94>
  neg = 0;
 448:	4881                	li	a7,0
 ...
 454:	52850513          	addi	a0,a0,1320 # 978 <digits>
 458:	883e                	mv	a6,a5
 ...
 488:	0028079b          	addiw	a5,a6,2
  ...
  while(--i >= 0)
 48c:	02f05663          	blez	a5,4b8 <printint+0x86>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4f0:	24090c63          	beqz	s2,748 <vprintf+0x27a>
 4f4:	8b2a                	mv	s6,a0
 4f6:	8a2e                	mv	s4,a1
 4f8:	8bb2                	mv	s7,a2
  state = 0;
 ...
 514:	468c8c93          	addi	s9,s9,1128 # 978 <digits>
 518:	a005                	j	538 <vprintf+0x6a>
        putc(fd, c0);
 51a:	85ca                	mv	a1,s2
 51c:	855a                	mv	a0,s6
 51e:	ef7ff0ef          	jal	ra,414 <putc>
 ...
 534:	20090a63          	beqz	s2,748 <vprintf+0x27a>
    c0 = fmt[i] & 0xff;
 ...
 546:	b7cd                	j	528 <vprintf+0x5a>
      if(c0) c1 = fmt[i+1] & 0xff;
 548:	c3c1                	beqz	a5,5c8 <vprintf+0xfa>
 ...
 558:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
 55c:	03878e63          	beq	a5,s8,598 <vprintf+0xca>
      } else if(c0 == 'l' && c1 == 'd'){
 560:	05a78863          	beq	a5,s10,5b0 <vprintf+0xe2>
      } else if(c0 == 'u'){
 564:	0db78b63          	beq	a5,s11,63a <vprintf+0x16c>
 ...
 56c:	10e78d63          	beq	a5,a4,686 <vprintf+0x1b8>
 ...
 574:	14e78263          	beq	a5,a4,6b8 <vprintf+0x1ea>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 'c'){
 578:	06300713          	li	a4,99
 57c:	16e78f63          	beq	a5,a4,6fa <vprintf+0x22c>
        putc(fd, va_arg(ap, uint32));
      } else if(c0 == 's'){
 580:	07300713          	li	a4,115
 584:	18e78563          	beq	a5,a4,70e <vprintf+0x240>
        if((s = va_arg(ap, char*)) == 0)
          s = "(null)";
        for(; *s; s++)
          putc(fd, *s);
      } else if(c0 == '%'){
 588:	05579063          	bne	a5,s5,5c8 <vprintf+0xfa>
        putc(fd, '%');
 58c:	85d6                	mv	a1,s5
 58e:	855a                	mv	a0,s6
 590:	e85ff0ef          	jal	ra,414 <putc>
 ...
 5a4:	855a                	mv	a0,s6
 5a6:	e8dff0ef          	jal	ra,432 <printint>
 5aa:	8bca                	mv	s7,s2
      state = 0;
 5ac:	4981                	li	s3,0
 5ae:	bfad                	j	528 <vprintf+0x5a>
      } else if(c0 == 'l' && c1 == 'd'){
 5b0:	03868663          	beq	a3,s8,5dc <vprintf+0x10e>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
 5b4:	05a68163          	beq	a3,s10,5f6 <vprintf+0x128>
      } else if(c0 == 'l' && c1 == 'u'){
 5b8:	09b68d63          	beq	a3,s11,652 <vprintf+0x184>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
 5bc:	03a68f63          	beq	a3,s10,5fa <vprintf+0x12c>
      } else if(c0 == 'l' && c1 == 'x'){
 5c0:	07800793          	li	a5,120
 5c4:	0cf68d63          	beq	a3,a5,69e <vprintf+0x1d0>
        putc(fd, '%');
 5c8:	85d6                	mv	a1,s5
 5ca:	855a                	mv	a0,s6
 5cc:	e49ff0ef          	jal	ra,414 <putc>
        putc(fd, c0);
 5d0:	85ca                	mv	a1,s2
 5d2:	855a                	mv	a0,s6
 5d4:	e41ff0ef          	jal	ra,414 <putc>
      state = 0;
 5d8:	4981                	li	s3,0
 5da:	b7b9                	j	528 <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 10, 1);
 ...
 5e8:	855a                	mv	a0,s6
 5ea:	e49ff0ef          	jal	ra,432 <printint>
        i += 1;
 ...
 5f2:	4981                	li	s3,0
        i += 1;
 5f4:	bf15                	j	528 <vprintf+0x5a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
 5f6:	03860563          	beq	a2,s8,620 <vprintf+0x152>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
 5fa:	07b60963          	beq	a2,s11,66c <vprintf+0x19e>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
 5fe:	07800793          	li	a5,120
 602:	fcf613e3          	bne	a2,a5,5c8 <vprintf+0xfa>
        printint(fd, va_arg(ap, uint64), 16, 0);
 ...
 612:	855a                	mv	a0,s6
 614:	e1fff0ef          	jal	ra,432 <printint>
        i += 2;
 ...
 62c:	855a                	mv	a0,s6
 62e:	e05ff0ef          	jal	ra,432 <printint>
        i += 2;
 ...
 646:	855a                	mv	a0,s6
 648:	debff0ef          	jal	ra,432 <printint>
 64c:	8bca                	mv	s7,s2
      state = 0;
 64e:	4981                	li	s3,0
 650:	bde1                	j	528 <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 10, 0);
 ...
 65e:	855a                	mv	a0,s6
 660:	dd3ff0ef          	jal	ra,432 <printint>
        i += 1;
 ...
 678:	855a                	mv	a0,s6
 67a:	db9ff0ef          	jal	ra,432 <printint>
        i += 2;
 ...
 692:	855a                	mv	a0,s6
 694:	d9fff0ef          	jal	ra,432 <printint>
 698:	8bca                	mv	s7,s2
      state = 0;
 69a:	4981                	li	s3,0
 69c:	b571                	j	528 <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 16, 0);
 ...
 6aa:	855a                	mv	a0,s6
 6ac:	d87ff0ef          	jal	ra,432 <printint>
        i += 1;
 ...
 6c8:	855a                	mv	a0,s6
 6ca:	d4bff0ef          	jal	ra,414 <putc>
  putc(fd, 'x');
 6ce:	07800593          	li	a1,120
 6d2:	855a                	mv	a0,s6
 6d4:	d41ff0ef          	jal	ra,414 <putc>
 6d8:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 ...
 6e4:	855a                	mv	a0,s6
 6e6:	d2fff0ef          	jal	ra,414 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
 6ea:	0992                	slli	s3,s3,0x4
 6ec:	397d                	addiw	s2,s2,-1
 6ee:	fe0916e3          	bnez	s2,6da <vprintf+0x20c>
        printptr(fd, va_arg(ap, uint64));
 6f2:	f8843b83          	ld	s7,-120(s0)
      state = 0;
 6f6:	4981                	li	s3,0
 6f8:	bd05                	j	528 <vprintf+0x5a>
        putc(fd, va_arg(ap, uint32));
 6fa:	008b8913          	addi	s2,s7,8
 6fe:	000bc583          	lbu	a1,0(s7)
 702:	855a                	mv	a0,s6
 704:	d11ff0ef          	jal	ra,414 <putc>
 708:	8bca                	mv	s7,s2
      state = 0;
 70a:	4981                	li	s3,0
 70c:	bd31                	j	528 <vprintf+0x5a>
        if((s = va_arg(ap, char*)) == 0)
 70e:	008b8993          	addi	s3,s7,8
 712:	000bb903          	ld	s2,0(s7)
 716:	00090f63          	beqz	s2,734 <vprintf+0x266>
        for(; *s; s++)
 71a:	00094583          	lbu	a1,0(s2)
 71e:	c195                	beqz	a1,742 <vprintf+0x274>
          putc(fd, *s);
 720:	855a                	mv	a0,s6
 722:	cf3ff0ef          	jal	ra,414 <putc>
        for(; *s; s++)
 726:	0905                	addi	s2,s2,1
 728:	00094583          	lbu	a1,0(s2)
 72c:	f9f5                	bnez	a1,720 <vprintf+0x252>
        if((s = va_arg(ap, char*)) == 0)
 72e:	8bce                	mv	s7,s3
      state = 0;
 730:	4981                	li	s3,0
 732:	bbdd                	j	528 <vprintf+0x5a>
          s = "(null)";
 734:	00000917          	auipc	s2,0x0
 738:	23c90913          	addi	s2,s2,572 # 970 <malloc+0x12c>
        for(; *s; s++)
 73c:	02800593          	li	a1,40
 740:	b7c5                	j	720 <vprintf+0x252>
        if((s = va_arg(ap, char*)) == 0)
 742:	8bce                	mv	s7,s3
      state = 0;
 744:	4981                	li	s3,0
 746:	b3cd                	j	528 <vprintf+0x5a>
    }
  }
}
...
fprintf(int fd, const char *fmt, ...)
{
 ...
 77e:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
 782:	8622                	mv	a2,s0
 784:	d4bff0ef          	jal	ra,4ce <vprintf>
}
...
printf(const char *fmt, ...)
{
 ...
 7b2:	85aa                	mv	a1,a0
 7b4:	4505                	li	a0,1
 7b6:	d19ff0ef          	jal	ra,4ce <vprintf>
}
...
malloc(uint nbytes)
{
 ...
 8f8:	ecbff0ef          	jal	ra,7c2 <free>
  return freep;
 8fc:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
 900:	dd61                	beqz	a0,8d8 <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 902:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 904:	4798                	lw	a4,8(a5)
 906:	fa9777e3          	bgeu	a4,s1,8b4 <malloc+0x70>
    if(p == freep)
 90a:	00093703          	ld	a4,0(s2)
 90e:	853e                	mv	a0,a5
 910:	fef719e3          	bne	a4,a5,902 <malloc+0xbe>
  p = sbrk(nu * sizeof(Header));
 914:	8552                	mv	a0,s4
 916:	a23ff0ef          	jal	ra,338 <sbrk>
  if(p == SBRK_ERROR)
 91a:	fd551ce3          	bne	a0,s5,8f2 <malloc+0xae>
        return 0;
 91e:	4501                	li	a0,0
 920:	bf65                	j	8d8 <malloc+0x94>
