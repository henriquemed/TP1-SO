...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 47e:	52650513          	addi	a0,a0,1318 # 9a0 <digits>
 482:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 53e:	466c8c93          	addi	s9,s9,1126 # 9a0 <digits>
 ...
 762:	23a90913          	addi	s2,s2,570 # 998 <malloc+0x12a>
        for(; *s; s++)
